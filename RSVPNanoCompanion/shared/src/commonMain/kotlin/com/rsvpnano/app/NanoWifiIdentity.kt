...
object NanoWifiIdentity {
    const val SSID_PREFIX = "RSVP-M5-"
    // Older RSVP Nano devices used these SSID prefixes; still recognised so the app pairs with them.
    val LEGACY_SSID_PREFIXES = listOf("RSVP-Nano-", "RSVP_Nano-")
    ...
    fun isNanoSsid(value: String?): Boolean {
        ...
        return clean.startsWith(SSID_PREFIX) || LEGACY_SSID_PREFIXES.any { clean.startsWith(it) }
    }
